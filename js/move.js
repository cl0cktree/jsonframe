		...
		$.getJSON(jsonFrame_data, function(data){
			$.each(data, function(I, item){
				...
				function contents_box(){
					...
					$('.move-wrap'+work_years).append('<a class="scrollall-con-box" role="button" id="scroll'+work_years+'-con-box'+item.years_num+'"><div id="con-box'+work_years+'-imgborder'+item.years_num+'" class="con-box-imgborder">\
					<img src="'+item.data_img+'" alt="'+item.data_alt+'"></div><div id="con-box'+work_years+'-caption'+item.years_num+'" class="con-box-caption"><span>'+item.data_title+'</span></div></a>');
				};
